      ...
      <div class="grid grid-cols-12 h-full gap-6 divide-x absolute inset-0">
        <div class="col-span-12 lg:col-span-8 py-4 max-w-3xl mx-auto">
          ...
          <div class="mt-8 flex gap-2">
            <Link href="/post-a-job?tab=1" class="btn">
              <iconify-icon
                width={24}
                height={24}
              ...
              {url && (
                <div>
                  ...
                  <p class="text-xs prose mt-4">
                    You’ll be redirected to Stripe to checkout with creditcard.
                    Prefer a different payment method or need a PO? Contact us.
                  </p>
                </div>
              )}
            </div>
